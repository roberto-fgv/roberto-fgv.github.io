  ...
  return (
    ...
    >
      <div className="section-container">
        <h2 className="section-title text-center animate-item">
          Competências Acadêmicas
        </h2>
        <p className="section-subtitle text-center animate-item">
          Áreas de conhecimento e expertise desenvolvidas ao longo da carreira
          acadêmica
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-12">
          <div className="glass-card rounded-xl p-6 animate-item">
            ...
            <p className="text-muted-foreground mb-6">
              Crescimento contínuo nas métricas acadêmicas e índices de impacto
              das publicações
            </p>
